...
#if PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_pywintun_pmd3(void)
#else
PyMODINIT_FUNC
initpywintun_pmd3(void)
#endif
{
    PyObject *m;
...
#else
    m = Py_InitModule("pywintun_pmd3", NULL);
#endif
    ...
    py_wintun_error = PyErr_NewException("pywintun_pmd3.Error", PyExc_IOError, pytun_error_dict);
